...
--
-- Class AccountDeletionRequest as table account_deletion_request
--
...
--
-- Class AnonymousPlayer as table anonymous_player
--
...
--
-- Class GeoLocation as table geo_locations
--
...
--
-- Class GooglePlaceLocation as table google_place_locations
--
...
--
-- Class ManualInputLocation as table manual_input_locations
--
...
--
-- Class MatchChatHistory as table match_chat_history
--
...
--
-- Class MatchChatMessage as table match_chat_message
--
CREATE TABLE "match_chat_message" (
    ...
    "imageUrl" text,
    "audioUrl" text,
    "audioDurationMilliseconds" bigint,
    "replyToMessageId" bigint,
    "replyToMessagePreview" text,
    "replyToMessageUiType" text,
    "replyToMessageSenderPlayerDataId" bigint,
    "replyToAudioDurationMilliseconds" bigint,
    "reactionsJson" text,
    "blurhash" text,
    "imageWidth" bigint,
    "imageHeight" bigint,
...
--
-- Class MatchChatParticipantState as table match_chat_participant_state
--
CREATE TABLE "match_chat_participant_state" (
    ...
    "lastTypingAt" timestamp without time zone,
...
--
-- Class MatchInPersonProof as table match_in_person_proof
--
...
--
-- Class MatchSchedulePairingAttempt as table match_schedule_pairing_attempt
--
CREATE TABLE "match_schedule_pairing_attempt" (
    ...
    "notPlayedReason" text,
    "notPlayedReasonDetails" text,
    "notPlayedMarkedByPlayerDataId" bigint,
    "closedForSubscriptions" boolean,
    "locationId" bigint NOT NULL,
    "locationAdditionalInfo" text,
    "playerDataId" bigint NOT NULL
);
...
--
-- Class MatchSubscription as table match_subscriptions
--
...
--
-- Class PlayedMatch as table played_match
--
...
--
-- Class PlayerData as table player_data
--
CREATE TABLE "player_data" (
    "id" bigserial PRIMARY KEY,
    "authUserId" uuid NOT NULL,
    "displayName" text NOT NULL,
    "preferredLanguage" text NOT NULL DEFAULT 'english'::text,
...
--
-- Class PlayerInMatch as table player_in_match
--
...
--
-- Class PlayerPerfomanceInMatch as table player_perfomance_in_match
--
...
--
-- Class PlayerPushNotificationToken as table player_push_notification_token
--
...
--
-- Class WebAnalyticsClick as table web_analytics_click
--
...
--
-- Class WebIpLocationCache as table web_ip_location_cache
--
...
--
-- Foreign relations for "anonymous_player" table
--
...
--
-- Foreign relations for "locations" table
--
...
--
-- Foreign relations for "manual_input_locations" table
--
...
--
-- Foreign relations for "match_chat_history" table
--
...
--
-- Foreign relations for "match_chat_message" table
--
...
--
-- Foreign relations for "match_chat_participant_state" table
--
...
--
-- Foreign relations for "match_in_person_proof" table
--
...
--
-- Foreign relations for "match_schedule_pairing_attempt" table
--
...
--
-- Foreign relations for "match_subscriptions" table
--
...
--
-- Foreign relations for "played_match" table
--
...
--
-- Foreign relations for "player_data" table
--
...
--
-- Foreign relations for "player_in_match" table
--
...
--
-- Foreign relations for "player_perfomance_in_match" table
--
...
--
-- Foreign relations for "player_push_notification_token" table
--
...
INSERT INTO "serverpod_migrations" ("module", "version", "timestamp")
    VALUES ('root_hub', '20260309035853866-add-location-additional-info', now())
    ON CONFLICT ("module")
    DO UPDATE SET "version" = '20260309035853866-add-location-additional-info', "timestamp" = now();

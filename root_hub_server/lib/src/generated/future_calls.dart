...
import '../future_calls/mark_stale_match_schedules_not_played_periodic_call.dart'
    as _i3;
...
class FutureCalls extends _i1.FutureCallDispatch<_FutureCallRef> {
  ...
  void initialize(
    ...
    var registeredFutureCalls = <String, _i1.FutureCall>{
      'MarkStaleMatchSchedulesNotPlayedPeriodicCallInvokeFutureCall':
          MarkStaleMatchSchedulesNotPlayedPeriodicCallInvokeFutureCall(),
    };
...
class _FutureCallRef {
  ...
  late final markStaleMatchSchedulesNotPlayedPeriodicCall =
      _MarkStaleMatchSchedulesNotPlayedPeriodicCallFutureCallDispatcher(
        _invokeFutureCall,
      );
}

class _MarkStaleMatchSchedulesNotPlayedPeriodicCallFutureCallDispatcher {
  _MarkStaleMatchSchedulesNotPlayedPeriodicCallFutureCallDispatcher(
...
class MarkStaleMatchSchedulesNotPlayedPeriodicCallInvokeFutureCall
  ...
  _i2.Future<void> invoke(
    ...
    await _i3.MarkStaleMatchSchedulesNotPlayedPeriodicCall().invoke(
      session,
      object,
    );
  }

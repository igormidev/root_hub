...
abstract class WebAnalyticsDashboard
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      ...
      'uniqueCountries': uniqueCountries,
      'uniqueDevices': uniqueDevices,
      'countryMetrics': countryMetrics.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'deviceMetrics': deviceMetrics.toJson(
        valueToJson: (v) => v.toJsonForProtocol(),
      ),
      'timeline': timeline.toJson(valueToJson: (v) => v.toJsonForProtocol()),
      'clicksPagination': clicksPagination.toJsonForProtocol(),
    };
  }

...
abstract class SubscribedMatchesPagination
    implements _i1.SerializableModel, _i1.ProtocolSerialization {
  SubscribedMatchesPagination._({
    required this.matches,
    required this.paginationMetadata,
  });

  factory SubscribedMatchesPagination({
    required List<_i2.MatchSubscription> matches,
    required _i3.PaginationMetadata paginationMetadata,
  }) = _SubscribedMatchesPaginationImpl;

  factory SubscribedMatchesPagination.fromJson(
  ...
  /// Returns a shallow copy of this [SubscribedMatchesPagination]
  /// with some or all fields replaced by the given arguments.
  @_i1.useResult
  SubscribedMatchesPagination copyWith({
    List<_i2.MatchSubscription>? matches,
    _i3.PaginationMetadata? paginationMetadata,
  });
  @override
  Map<String, dynamic> toJson() {
    return {
      '__className__': 'SubscribedMatchesPagination',
  ...
  Map<String, dynamic> toJsonForProtocol() {
    return {
      '__className__': 'SubscribedMatchesPagination',
      'matches': matches.toJson(valueToJson: (v) => v.toJsonForProtocol()),
...
class _SubscribedMatchesPaginationImpl extends SubscribedMatchesPagination {
  _SubscribedMatchesPaginationImpl({
    required List<_i2.MatchSubscription> matches,
    required _i3.PaginationMetadata paginationMetadata,
  }) : super._(

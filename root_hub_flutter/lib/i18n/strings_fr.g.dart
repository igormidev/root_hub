...
class _TranslationsHomeFr extends TranslationsHomeEn {
	...
	@override late final _TranslationsHomeUiScreensRecommendedCompositionsScreenFr ui_screens_recommended_compositions_screen = _TranslationsHomeUiScreensRecommendedCompositionsScreenFr._(_root);
...
class _TranslationsMatchFr extends TranslationsMatchEn {
	...
	@override late final _TranslationsMatchUiSheetsMatchCreateTableLocationConfirmationSheetFr ui_sheets_match_create_table_location_confirmation_sheet = _TranslationsMatchUiSheetsMatchCreateTableLocationConfirmationSheetFr._(_root);
...
class _TranslationsAuthAuthLoginScreenFr extends TranslationsAuthAuthLoginScreenEn {
	...
	@override String get signInWithEmailTitle => 'Se connecter avec e-mail';
	@override String get signUpWithEmailTitle => 'Créer un compte avec e-mail';
	@override String get verifyAccountTitle => 'Vérifier le compte';
	@override String get verifyAccountMessage => 'Un e-mail de vérification a été envoyé. Consultez votre e-mail et saisissez le code ci-dessous.';
	@override String get setAccountPasswordTitle => 'Définir le mot de passe du compte';
	@override String get resetPasswordTitle => 'Réinitialiser le mot de passe';
	@override String get requestResetDescription => 'Saisissez l\'e-mail de votre compte pour recevoir un code de réinitialisation.';
	@override String get verifyResetCodeTitle => 'Vérifier le code de réinitialisation';
	@override String get verifyResetMessage => 'Saisissez le code de réinitialisation envoyé à votre e-mail.';
	@override String get setNewPasswordTitle => 'Définir un nouveau mot de passe';
	@override String get emailLabel => 'E-mail';
	@override String get passwordLabel => 'Mot de passe';
	@override String get newPasswordLabel => 'Nouveau mot de passe';
	@override String get forgotPasswordButton => 'Mot de passe oublié ?';
	@override String get signInButton => 'Se connecter';
	@override String get signUpButton => 'Créer un compte';
	@override String get continueButton => 'Continuer';
	@override String get verifyButton => 'Vérifier';
	@override String get requestResetButton => 'Demander une réinitialisation';
	@override String get resetPasswordButton => 'Réinitialiser le mot de passe';
	@override String get dontHaveAnAccount => 'Vous n\'avez pas de compte ?';
	@override String get alreadyHaveAnAccount => 'Vous avez déjà un compte ?';
	@override String get signUpLink => 'Créer un compte';
	@override String get signInLink => 'Se connecter';
	@override String get backToSignIn => 'Retour à la connexion';
	@override String get resendCode => 'Rien reçu ? Envoyer un nouveau code';
	@override String resendCodeIn({required Object time}) => 'Envoyer un nouveau code (${time})';
	@override String get passwordRuleMinLength => 'Au moins 8 caractères';
	@override String get passwordRuleUppercase => 'Contient au moins une lettre majuscule';
	@override String get passwordRuleLowercase => 'Contient au moins une lettre minuscule';
	@override String get passwordRuleNumber => 'Contient au moins un chiffre';
	@override late final _TranslationsAuthAuthLoginScreenErrorsFr errors = _TranslationsAuthAuthLoginScreenErrorsFr._(_root);
}
...
class _TranslationsDashboardUiWidgetsDashboardProfileDrawerWidgetFr extends TranslationsDashboardUiWidgetsDashboardProfileDrawerWidgetEn {
	...
	@override String get themeDescriptionLight => 'Le mode clair est actif';
	@override String get themeDescriptionDark => 'Le mode sombre est actif';
	@override String get lightMode => 'Clair';
...
class _TranslationsActivityUiScreensActivityScreenFr extends TranslationsActivityUiScreensActivityScreenEn {
	...
	@override String get activeSchedulesTab => 'Actives';
	@override String get pastSchedulesTab => 'Passées';
	...
	@override String get tablesYouSubscribedToThatAlreadyLeftTheActiveWindow => 'Tables auxquelles vous êtes inscrit et qui ont déjà eu lieu ou ont quitté la fenêtre active.';
	...
	@override String get noPastSchedules => 'Aucune table passée pour le moment';
	@override String get onceOneOfYourSubscribedTablesLeavesTheActiveWindowItShowsUpHere => 'Quand l\'une de vos tables rejointes quitte la fenêtre active, elle apparaît ici.';
...
class _TranslationsActivityUiScreensChatScreenFr extends TranslationsActivityUiScreensChatScreenEn {
	...
	@override String get scheduledMatchesFilter => 'Parties planifiées';
	@override String get completedMatchesFilter => 'Parties terminées';
...
class _TranslationsHomeUiScreensHomeScreenFr extends TranslationsHomeUiScreensHomeScreenEn {
	...
	// Translations
	@override String get yourPersonalFactionPerformanceAndMatchProfile => 'Vos statistiques personnelles de faction basées uniquement sur les factions que vous avez jouées.';
	...
	@override String get noCommunityStatsYet => 'Aucune statistique de la communauté pour le moment';
	@override String get communityStatsWillAppearAfterCompletedMatches => 'Dès que les joueurs enregistreront des parties terminées, cette section affichera les tendances des factions.';
	@override String get noPersonalStatsYet => 'Aucune statistique personnelle pour le moment';
...
class _TranslationsHomeUiScreensAdvancedSetupQuickguideScreenFr extends TranslationsHomeUiScreensAdvancedSetupQuickguideScreenEn {
	...
	// Translations
	@override String get title => 'Mise en place avancée';
	@override String get referenceTitle => 'Référence de mise en place avancée';
	@override String get description => 'Cette référence suit le modèle public à 10 factions utilisé jusqu\'à Maraudeur.';
...
class _TranslationsHomeUiScreensRecommendedCompositionsScreenFr extends TranslationsHomeUiScreensRecommendedCompositionsScreenEn {
	_TranslationsHomeUiScreensRecommendedCompositionsScreenFr._(TranslationsFr root) : this._root = root, super.internal(root);
	...
	@override String get playerCountDescription => 'Choisissez la taille de table pour cette partie.';
	@override String get resultsTitle => 'Compositions compatibles';
	@override String get resultsDescription => 'Ces compositions correspondent aux boîtes que vous avez et au nombre de joueurs choisi.';
	@override late final _TranslationsHomeUiScreensRecommendedCompositionsScreenBoxNamesFr boxNames = _TranslationsHomeUiScreensRecommendedCompositionsScreenBoxNamesFr._(_root);
}
...
class _TranslationsMatchUiSheetsMatchCreateTableLocationConfirmationSheetFr extends TranslationsMatchUiSheetsMatchCreateTableLocationConfirmationSheetEn {
	_TranslationsMatchUiSheetsMatchCreateTableLocationConfirmationSheetFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get confirmLocation => 'Confirmer le lieu';
	@override String get createTableAtThisLocation => 'Créer une table à cet endroit';
	@override String get reviewTheSelectedLocationBeforePublishingYourMatch => 'Vérifiez le lieu sélectionné avant de publier votre partie.';
	@override String get selectedLocation => 'Lieu sélectionné';
	@override String get locationAdditionalInfoOptional => 'Infos supplémentaires sur le lieu (optionnel)';
	@override String get addOptionalExtraDirectionsOrMeetingDetailsForThisLocation => 'Ajoutez des indications ou des détails de rendez-vous pour aider les joueurs à trouver la table exacte.';
	@override String get exampleWeWillBeUpstairsNearTheBackTablesAskForTheRootGroup => 'Exemple : Nous serons à l’étage, près des tables du fond. Demandez le groupe ROOT.';
	@override String get back => 'Retour';
	@override String get createTable => 'Créer la table';
}
...
class _TranslationsMatchUiScreensMatchCreateTableLocationScreenFr extends TranslationsMatchUiScreensMatchCreateTableLocationScreenEn {
	...
	@override String get tapALocationToSelectIt => 'Appuyez sur un lieu pour le sélectionner.';
	...
	@override String get continueButton => 'Continuer';
	@override String get tableCreatedSuccessTitle => 'Table créée avec succès';
	@override String get tableCreatedSuccessDescription => 'Votre partie est maintenant publiée et les autres joueurs peuvent s’y inscrire.';
	@override String get tableCreatedSuccessDetails => 'Vous pouvez rouvrir le chat et suivre les inscriptions depuis les onglets Parties et Chat.';
	@override String get close => 'Fermer';
}
...
class _TranslationsMatchUiScreensMatchScreenFr extends TranslationsMatchUiScreensMatchScreenEn {
	...
	@override String get reportResult => 'Noter partie';
}
...
class _TranslationsMatchUiSheetsMatchShareSheetFr extends TranslationsMatchUiSheetsMatchShareSheetEn {
	_TranslationsMatchUiSheetsMatchShareSheetFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get shareThisMatch => 'Partager cette partie';
	@override String get copyOrShareToInvitePlayers => 'Copiez le lien ou partagez-le pour inviter des joueurs.';
	@override String get copyLink => 'Copier le lien';
	@override String get copied => 'Copié';
	@override String get orDivider => 'OU';
	@override String get shareInWhatsApp => 'Partager sur WhatsApp';
	@override String get shareInMessenger => 'Partager sur Messenger';
	@override String get shareInTelegram => 'Partager sur Telegram';
	@override String get chooseWhereToShare => 'Choisir où partager';
	@override String get copyFailed => 'Impossible de copier le lien.';
	@override String get unableToOpenWhatsApp => 'Impossible d\'ouvrir WhatsApp pour le moment.';
	@override String get unableToOpenTelegram => 'Impossible d\'ouvrir Telegram pour le moment.';
}
...
class _TranslationsMatchUiScreensMatchChatScreenFr extends TranslationsMatchUiScreensMatchChatScreenEn {
	...
	@override String get confirmPhoto => 'Confirmer la photo';
	@override String get addAMessageOptional => 'Ajouter un message (optionnel)';
	@override String get sendPhoto => 'Envoyer la photo';
	...
	@override String get replyAction => 'Répondre';
	@override String get deleteMessageAction => 'Supprimer';
	@override String get dismissAction => 'Fermer';
	@override String get deleteMessageTitle => 'Supprimer le message ?';
	@override String get deleteMessageDescription => 'Cela supprimera le message pour tout le monde dans le chat de la table.';
...
class _TranslationsRegisterMatchUiSheetsRegisterMatchWizardWinnerStepSectionFr extends TranslationsRegisterMatchUiSheetsRegisterMatchWizardWinnerStepSectionEn {
	...
	@override String get dominanceCoalition => 'Dominance (coalition)';
	...
	@override String get vagabondCoalitionWin => 'Victoire en coalition avec le Vagabond';
	@override String get ifWinnerWonByDominanceSelectOneVagabondToWinToo => 'Si le gagnant a gagné par domination via une coalition, sélectionnez un Vagabond qui a aussi gagné.';
	@override String get selectingVagabondForcesDominance => 'Sélectionner un Vagabond ici force la domination comme méthode de victoire.';
}
...
class _TranslationsRegisterMatchUiSheetsRegisterMatchWizardFactionsStepSectionFr extends TranslationsRegisterMatchUiSheetsRegisterMatchWizardFactionsStepSectionEn {
	...
	@override String get firstVagabond => 'Premier Vagabond';
	@override String get secondVagabond => 'Second Vagabond';
}
...
class _TranslationsRegisterMatchUiSheetsRegisterMatchWizardSheetFr extends TranslationsRegisterMatchUiSheetsRegisterMatchWizardSheetEn {
	...
	@override String onlyVagabondCanBeSelectedMoreThanOnce({required Object factionName}) => '${factionName} ne peut pas être répétée. Seul le Vagabond peut être sélectionné plus d’une fois.';
	@override String get youCanSelectAtMostTwoVagabonds => 'Vous pouvez sélectionner au maximum deux Vagabonds.';
	@override String get coalitionWinnerMustBeInTheParticipantList => 'Le gagnant de coalition sélectionné n’est plus dans la liste des participants.';
	@override String get coalitionWinnerMustBeDifferentFromTheMainWinner => 'Le gagnant de coalition doit être différent du gagnant principal.';
	@override String get coalitionWinnerMustBeAVagabond => 'Seul un Vagabond peut être sélectionné comme gagnant de coalition.';
	@override String get coalitionWinRequiresDominance => 'Une victoire en coalition exige la domination comme méthode de victoire.';
}
...
class _TranslationsAuthAuthLoginScreenErrorsFr extends TranslationsAuthAuthLoginScreenErrorsEn {
	_TranslationsAuthAuthLoginScreenErrorsFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get invalidEmail => 'Adresse e-mail invalide.';
	@override String get emailAliasNotAllowed => 'Les alias d’e-mail comme nom+tag@exemple.com ne sont pas pris en charge. Utilisez votre adresse principale.';
	@override String get accountAlreadyExists => 'Un compte avec cet e-mail existe déjà. Connectez-vous ou réinitialisez votre mot de passe.';
	@override String get accountNotFound => 'Aucun compte n’a été trouvé pour cet e-mail. Vérifiez l’adresse ou créez un nouveau compte.';
	@override String get invalidPassword => 'Ce mot de passe est incorrect. Vérifiez-le puis réessayez.';
	@override String get accountBlocked => 'Ce compte est actuellement bloqué. Contactez le support si cela semble être une erreur.';
	@override String get invalidCredentials => 'E-mail ou mot de passe invalide. Vérifiez vos identifiants et réessayez.';
	@override String get tooManyLoginAttempts => 'Trop de tentatives de connexion. Réessayez plus tard.';
	@override String get loginFailed => 'Une erreur est survenue lors de la connexion. Réessayez.';
	@override String get tooManyRegistrationAttempts => 'Trop de tentatives d\'inscription. Réessayez plus tard.';
	@override String get verificationCodeExpired => 'Le code de vérification a expiré. Demandez-en un nouveau.';
	@override String get invalidVerificationCode => 'Code de vérification invalide. Vérifiez-le et réessayez.';
	@override String get passwordPolicyViolation => 'Le mot de passe ne respecte pas les exigences. Choisissez-en un autre.';
	@override String get registrationFailed => 'Une erreur est survenue pendant l\'inscription. Réessayez plus tard.';
	@override String get tooManyPasswordResetAttempts => 'Trop de tentatives de réinitialisation du mot de passe. Réessayez plus tard.';
...
class _TranslationsHomeUiScreensRecommendedCompositionsScreenBoxNamesFr extends TranslationsHomeUiScreensRecommendedCompositionsScreenBoxNamesEn {
	_TranslationsHomeUiScreensRecommendedCompositionsScreenBoxNamesFr._(TranslationsFr root) : this._root = root, super.internal(root);

	final TranslationsFr _root; // ignore: unused_field

	// Translations
	@override String get baseGame => 'Jeu de base';
	@override String get riverfolkExpansion => 'Extension Riverfolk';
	@override String get underworldExpansion => 'Extension Underworld';
	@override String get marauderExpansion => 'Extension Maraudeur';
}

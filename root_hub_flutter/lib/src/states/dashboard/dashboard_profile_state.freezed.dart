...
@override
int get hashCode => Object.hash(runtimeType,profileImageUrl,hasLoadedProfileImage,isLoadingProfileImage,isUpdatingProfileImage,isUpdatingDisplayName,isUpdatingLocation,isResolvingLocationLabel,isUpdatingFaction,resolvedLocationLabelKey,resolvingLocationLabelKey,currentLocationCityName,currentLocationShortAddress,currentLocationFormattedAddress,lastError);

@override
String toString() {
  return 'DashboardProfileState(profileImageUrl: $profileImageUrl, hasLoadedProfileImage: $hasLoadedProfileImage, isLoadingProfileImage: $isLoadingProfileImage, isUpdatingProfileImage: $isUpdatingProfileImage, isUpdatingDisplayName: $isUpdatingDisplayName, isUpdatingLocation: $isUpdatingLocation, isResolvingLocationLabel: $isResolvingLocationLabel, isUpdatingFaction: $isUpdatingFaction, resolvedLocationLabelKey: $resolvedLocationLabelKey, resolvingLocationLabelKey: $resolvingLocationLabelKey, currentLocationCityName: $currentLocationCityName, currentLocationShortAddress: $currentLocationShortAddress, currentLocationFormattedAddress: $currentLocationFormattedAddress, lastError: $lastError)';
}
...
@useResult
$Res call({
 String? profileImageUrl, bool hasLoadedProfileImage, bool isLoadingProfileImage, bool isUpdatingProfileImage, bool isUpdatingDisplayName, bool isUpdatingLocation, bool isResolvingLocationLabel, bool isUpdatingFaction, String? resolvedLocationLabelKey, String? resolvingLocationLabelKey, String? currentLocationCityName, String? currentLocationShortAddress, String? currentLocationFormattedAddress, RootHubException? lastError
});
...
/// Create a copy of DashboardProfileState
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? profileImageUrl = freezed,Object? hasLoadedProfileImage = null,Object? isLoadingProfileImage = null,Object? isUpdatingProfileImage = null,Object? isUpdatingDisplayName = null,Object? isUpdatingLocation = null,Object? isResolvingLocationLabel = null,Object? isUpdatingFaction = null,Object? resolvedLocationLabelKey = freezed,Object? resolvingLocationLabelKey = freezed,Object? currentLocationCityName = freezed,Object? currentLocationShortAddress = freezed,Object? currentLocationFormattedAddress = freezed,Object? lastError = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String? profileImageUrl,  bool hasLoadedProfileImage,  bool isLoadingProfileImage,  bool isUpdatingProfileImage,  bool isUpdatingDisplayName,  bool isUpdatingLocation,  bool isResolvingLocationLabel,  bool isUpdatingFaction,  String? resolvedLocationLabelKey,  String? resolvingLocationLabelKey,  String? currentLocationCityName,  String? currentLocationShortAddress,  String? currentLocationFormattedAddress,  RootHubException? lastError)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _DashboardProfileState() when $default != null:
return $default(_that.profileImageUrl,_that.hasLoadedProfileImage,_that.isLoadingProfileImage,_that.isUpdatingProfileImage,_that.isUpdatingDisplayName,_that.isUpdatingLocation,_that.isResolvingLocationLabel,_that.isUpdatingFaction,_that.resolvedLocationLabelKey,_that.resolvingLocationLabelKey,_that.currentLocationCityName,_that.currentLocationShortAddress,_that.currentLocationFormattedAddress,_that.lastError);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String? profileImageUrl,  bool hasLoadedProfileImage,  bool isLoadingProfileImage,  bool isUpdatingProfileImage,  bool isUpdatingDisplayName,  bool isUpdatingLocation,  bool isResolvingLocationLabel,  bool isUpdatingFaction,  String? resolvedLocationLabelKey,  String? resolvingLocationLabelKey,  String? currentLocationCityName,  String? currentLocationShortAddress,  String? currentLocationFormattedAddress,  RootHubException? lastError)  $default,) {final _that = this;
switch (_that) {
case _DashboardProfileState():
return $default(_that.profileImageUrl,_that.hasLoadedProfileImage,_that.isLoadingProfileImage,_that.isUpdatingProfileImage,_that.isUpdatingDisplayName,_that.isUpdatingLocation,_that.isResolvingLocationLabel,_that.isUpdatingFaction,_that.resolvedLocationLabelKey,_that.resolvingLocationLabelKey,_that.currentLocationCityName,_that.currentLocationShortAddress,_that.currentLocationFormattedAddress,_that.lastError);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String? profileImageUrl,  bool hasLoadedProfileImage,  bool isLoadingProfileImage,  bool isUpdatingProfileImage,  bool isUpdatingDisplayName,  bool isUpdatingLocation,  bool isResolvingLocationLabel,  bool isUpdatingFaction,  String? resolvedLocationLabelKey,  String? resolvingLocationLabelKey,  String? currentLocationCityName,  String? currentLocationShortAddress,  String? currentLocationFormattedAddress,  RootHubException? lastError)?  $default,) {final _that = this;
switch (_that) {
case _DashboardProfileState() when $default != null:
return $default(_that.profileImageUrl,_that.hasLoadedProfileImage,_that.isLoadingProfileImage,_that.isUpdatingProfileImage,_that.isUpdatingDisplayName,_that.isUpdatingLocation,_that.isResolvingLocationLabel,_that.isUpdatingFaction,_that.resolvedLocationLabelKey,_that.resolvingLocationLabelKey,_that.currentLocationCityName,_that.currentLocationShortAddress,_that.currentLocationFormattedAddress,_that.lastError);case _:
  return null;
...
class _DashboardProfileState implements DashboardProfileState {
  const _DashboardProfileState({this.profileImageUrl, this.hasLoadedProfileImage = false, this.isLoadingProfileImage = false, this.isUpdatingProfileImage = false, this.isUpdatingDisplayName = false, this.isUpdatingLocation = false, this.isResolvingLocationLabel = false, this.isUpdatingFaction = false, this.resolvedLocationLabelKey, this.resolvingLocationLabelKey, this.currentLocationCityName, this.currentLocationShortAddress, this.currentLocationFormattedAddress, this.lastError});

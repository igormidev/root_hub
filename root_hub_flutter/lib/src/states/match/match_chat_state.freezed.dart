...
as bool,isDeletingMessage: null == isDeletingMessage ? _self.isDeletingMessage : isDeletingMessage // ignore: cast_nullable_to_non_nullable
...
as RootHubException?,playedMatchSummaryError: freezed == playedMatchSummaryError ? _self.playedMatchSummaryError : playedMatchSummaryError // ignore: cast_nullable_to_non_nullable
as RootHubException?,playedMatchSummary: freezed == playedMatchSummary ? _self.playedMatchSummary : playedMatchSummary // ignore: cast_nullable_to_non_nullable
as MatchChatPlayedMatchSummary?,subscribedPlayerIds: null == subscribedPlayerIds ? _self.subscribedPlayerIds : subscribedPlayerIds // ignore: cast_nullable_to_non_nullable
as Set<int>,
  ));
}
...
switch (_that) {
case _MatchChatState() when $default != null:
return $default(_that.scheduledMatchId,_that.isLoading,_that.hasLoadedOnce,_that.isLoadingMore,_that.hasNextPage,_that.currentPage,_that.isSendingMessage,_that.isUploadingImage,_that.isUploadingAudio,_that.isDeletingMessage,_that.isLoadingPlayedMatchSummary,_that.loadError,_that.actionError,_that.playedMatchSummaryError,_that.playedMatchSummary,_that.subscribedPlayerIds);case _:
  return orElse();
...
@override@JsonKey() final  bool isDeletingMessage;
...
@override final  RootHubException? playedMatchSummaryError;
@override final  MatchChatPlayedMatchSummary? playedMatchSummary;
...
@override
int get hashCode => Object.hash(runtimeType,scheduledMatchId,isLoading,hasLoadedOnce,isLoadingMore,hasNextPage,currentPage,isSendingMessage,isUploadingImage,isUploadingAudio,isDeletingMessage,isLoadingPlayedMatchSummary,loadError,actionError,playedMatchSummaryError,playedMatchSummary,const DeepCollectionEquality().hash(_subscribedPlayerIds));
...
as RootHubException?,playedMatchSummaryError: freezed == playedMatchSummaryError ? _self.playedMatchSummaryError : playedMatchSummaryError // ignore: cast_nullable_to_non_nullable
as RootHubException?,playedMatchSummary: freezed == playedMatchSummary ? _self.playedMatchSummary : playedMatchSummary // ignore: cast_nullable_to_non_nullable
as MatchChatPlayedMatchSummary?,subscribedPlayerIds: null == subscribedPlayerIds ? _self._subscribedPlayerIds : subscribedPlayerIds // ignore: cast_nullable_to_non_nullable
as Set<int>,
  ));
}
